...
# This is a  verbatim translation of https://www.w3.org/TR/html5/entities.json,
# into ruby.  Because "this software  or document includes material copied from
# or derived  from" above URL,  the W3C® Software License  shown at the  top of
# this file  must apply.  The  translation is  a fully automatic  process.  The
# person who  did that (@shyouhei) do  not claim any copyright  or intellectual
# properties over  this particular generated output.   Attribution shall belong
# to the original authors.

require_relative 'deeply_frozen'
using Optdown::DeeplyFrozen

# @see http://spec.commonmark.org/0.28/#entity-and-numeric-character-references
# @see https://html.spec.whatwg.org/multipage/named-characters.html
# @see https://html.spec.whatwg.org/multipage/entities.json
# @note As written in the {file:README.md},  we use W3C's entities.json instead
#       of  WHATWG's because  of its  unclear  licensing.  They  shall be  very
#       similar if not identical.
Optdown::HTML5ENTITY = deeply_frozen_copy_of({
  "&Aacute;" => {
    "codepoints" => [ 193 ],
    "characters" => "\u00C1",
  },
